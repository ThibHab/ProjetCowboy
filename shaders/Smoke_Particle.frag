...
vec3 base = vec3(0.8745, 0.4431, 0.29);
vec3 pale = vec3(0.874509803921,0.29411764705882354,0.12549019607843137);
vec3 yellow = vec3(1.0, 1.0, 0.0); // RGB for yellow
vec3 orange = vec3(1.0,0.41568627450980394,0.16470588235294117); // max value is 1.0
vec3 dark = vec3(0.5176470588235294,0.11372549019607843,0.06274509803921569);
